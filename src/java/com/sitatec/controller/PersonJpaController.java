...
public class PersonJpaController {
    ...
    public void create(Person person) throws PreexistingEntityException, Exception {
        ...
        // Asign autogenerated
        person.setId(getAutogeneratedId());
        
        if (findPersonByUsername(person.getUsername()) != null) {
            throw new PreexistingEntityException("Usuario " + person.getUsername() + " ya existe.");
        }

        try {
            Long.parseLong(person.getPhone());
        } catch (Exception ex) {
            throw new Exception("El teléfono fijo debe contener únicamente números.");
        }

        try {
            Long.parseLong(person.getMobilePhone());
        } catch (Exception ex) {
            throw new Exception("El teléfono celular debe contener únicamente números.");
        }
        ...
        try {
            ...
            if (findPerson(person.getId()) != null) {
                throw new PreexistingEntityException("Usuario " + person + " ya existe.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
